...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("oi nyungg", "Mau nanya dongg..", "question").then(function () {
    Swal.fire("Jawab yang jujur tapi ya!").then(function () {
      Swal.fire("Awas ae kalo bohong", "", "error").then(function () {
        ...
        const {
          ...
          const pertanyaan = Swal.fire({
            ...
            if (result.isConfirmed) {
              Swal.fire(`${sender} juga sayang, sayaaaaanggg banget sama ${nama}`).then(function () {
                Swal.fire({
                  title: 'Seberapa sayang si emangnya?',
                  icon: 'question',
                  input: 'range',
                  ...
                  Swal.fire(`Makasih ya udah sayang sama ${sender} ${val}%`).then(function () {
                    Swal.fire({
                      ...
                      /* Read more about isConfirmed, isDenied below */
                      if (result.isConfirmed) {
                        Swal.fire(`hihiw sama lagi ${sender} juga kangen ${nama} , kangen banget.. makasihhh yaa`).then(function () {
